...
class Tray : public mate::EventEmitter,
 ...
 protected:
  ...
  void Destroy();
  void SetImage(mate::Arguments* args, const gfx::ImageSkia& image, bool isTemplate = false);
  void SetPressedImage(mate::Arguments* args, const gfx::ImageSkia& image, bool isTemplate = false);
