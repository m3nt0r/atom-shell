...
class TrayIconCocoa : public TrayIcon {
 public:
  ...
  virtual void SetImage(const gfx::ImageSkia& image, bool isTemplate) OVERRIDE;
  virtual void SetPressedImage(const gfx::ImageSkia& image, bool isTemplate) OVERRIDE;
